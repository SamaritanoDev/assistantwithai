...
class PersonalizationRoutineScreen_ extends StatefulWidget {
  final Uint8List imageBytes;

  const PersonalizationRoutineScreen_({
    super.key,
    required this.imageBytes,
  });

  @override
  State<PersonalizationRoutineScreen_> createState() =>
      _PersonalizationRoutineScreen_State();
}

class _PersonalizationRoutineScreen_State
    extends State<PersonalizationRoutineScreen_> {
